...
def mol_to_svg(mol: type[Mol], sizex: int = 200, sizey: int = 200) -> str:
...
def molecule_from_smile(
    ...
    Returns
    -------
    molecule : object like rdkit.Chem.Mol
    ...
    if svg:
        return mol, mol_to_svg(mol, sizex=sizex, sizey=sizey)
    return mol, None
